...
// products
export const GET_ALL_PRODUCTS_URL = (cat, gender, pricelt, pricegt, sort, search) =>
  UrlParamsReplace(
    '/user/all-new-products?cat=:cat&gender=:gender&pricelt=:pricelt&pricegt=:pricegt&sort=:sort&search=:search',
    {
      cat,
      gender,
      pricelt,
